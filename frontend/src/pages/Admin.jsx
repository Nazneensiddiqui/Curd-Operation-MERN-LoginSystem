...
//           {/* Books Card */}
//           <Card style={{ flex: 1, margin: '0 5px', textAlign: 'center', backgroundColor: ' #f7e8c1' }}>
//             <Card.Body>
//               <FaBook size={30} />
    ...
    <Container fluid className="py-4">
      <Row className="justify-content-center">
        ...
        <Col xs={12} md={10} lg={8}>
          <Row className="g-3">
            {/* Books Card */}
            <Col xs={12} md={4}>
              <Card className="text-center shadow" style={{ backgroundColor: "#f7e8c1" }}>
                <Card.Body>
                  <FaBook size={30} />
                  <Card.Title>Books</Card.Title>
                  <Card.Text>{bookCount}</Card.Text>
            ...
            {/* Members Card */}
            <Col xs={12} md={4}>
              <Card className="text-center shadow" style={{ backgroundColor: "skyblue" }}>
                <Card.Body>
                  <FaUsers size={30} />
                  <Card.Title>Members</Card.Title>
                  <Card.Text>{memberCount}</Card.Text>
            ...
            {/* Admins Card */}
            <Col xs={12} md={4}>
              <Card className="text-center shadow" style={{ backgroundColor: "pink" }}>
                <Card.Body>
                  <FaUserShield size={30} />
                  <Card.Title>Admins</Card.Title>
                  <Card.Text>{adminCount}</Card.Text>
      ...
      <Row className="justify-content-center mt-4">
        <Col xs={12} md={5} className="mb-3">
          <div className="p-3 border rounded shadow" style={{ backgroundColor: "#f7e8c1" }}>
            <Pie data={pieData} options={pieOptions} />
          </div>
        </Col>
